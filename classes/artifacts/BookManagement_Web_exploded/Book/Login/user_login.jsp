...
<style type="text/css">
	*{
	...
	body{
	    ...
	    overflow: hidden;
		background-image: url(http://localhost:8080/BookManagement/Book/Image/book.png);
	}
	.container{
	    position: relative;
	    z-index: 1;
...
<body>
	<div class="container">
		<div class="login">
			...
			<div class="input">
				<form action="http://localhost:8080/BookManagement/UserLogin" method="post">
					<center>
					<br>
					<table>
                ...
                <a href="admin_login.jsp ">管理端登录</a><br>
                                            没有账号？<a href="user_register.jsp">去注册</a>
                </div>
			</div>
		</div>
	</div>
