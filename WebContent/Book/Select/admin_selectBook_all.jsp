...
<body>
	<table border="0" bgcolor="#ccceee" width="100%">
		...
		<td><a href="http://118.202.41.251:8080/BookManagement/AdminBookModify?bookdelete=null&from=out&operation=change&id=<%=nc.getId()%>">修改</a></td>
		<td><a href="http://118.202.41.251:8080/BookManagement/AdminBookModify?bookdelete=null&from=out&operation=delete&id=<%=nc.getId()%>">删除</a></td>
		</tr>
		<%
			}
		%>
