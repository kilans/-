...
<body>
	<table border="0" bgcolor="#ccceee" width="100%">
		...
		<td><a href="http://118.202.41.251:8080/BookManagement/AdminUserDelete?bookdelete=null&from=all&operation=delete&account=<%=nc.getAccount()%>">删除</a></td>
		</tr>
		<%
			}
		%>
